...
\begin{Proof}[\cref{fml:LU分解的方程求解}]
...
\begin{Equation}[浮点计算量]
    \Sum[k=1][n-1]2(n-k)^2=\frac{2n(n-1)(2n-1)}{6}\approx\frac{2n^3}{3}
\end{Equation}
...
简而言之，LU分解的浮点计算量是$\Obig(2n^3/3)$，部分选主元和完全选主元的应用则会额外导致$\Obig(n^2/2)$和$\Obig(n^3/3)$的比较计算量。完全选主元会使得比较计算量提升一个数量级！
